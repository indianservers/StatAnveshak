...
export function FrequencyPage() {
  ...
  if (!activeDataset) {
    return <DatasetEmptyState preferredPath="/explore/frequency" description="Load a dataset to create frequency tables for categorical, text, and coded variables." />
  }
